    ...
    <div className='p-4 py-[4rem] grid items-center gap-5 xl:pt-[7rem]'>
      ...
      <main className='grid gap-4 sm:w-[48rem] sm:mx-auto '>
        <section className='grid font-inter text-center'>
          ...
          <button className='mt-4 border-2 flex gap-2 justify-center border-dark1 rounded-[1.2rem] p-2 text-sm text-dark1 hover:scale-105'>
        ...
        <section className='sm:w-[48rem] sm:mx-auto'>
          <form className='w-full grid gap-2 font-work-sans'>
            ...
            <button
              className='bg-blue mt-2 p-4 rounded-[1.2rem] font-medium text-base text-white hover:scale-105'
              type='button'
            >
              Sign up
            </button>
