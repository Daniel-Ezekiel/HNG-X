...
const Home = () => {
  return (
    <div>
      <Header />
      <main>
        <section className='p-4 py-[8rem] grid gap-8'>
          <div className='flex flex-col gap-2 items-start font-work-sans text-lg'>
        ...
        <section className='border-t-[4rem] border-t-[#f4f6f8] p-4 py-[7rem] grid gap-8 font-work-sans'>
          <div>
